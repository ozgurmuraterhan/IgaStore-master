$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        var i = 0;
        while (i < length) {
            const checkBoxId = $(".form-check-input")
                .eq(i)
                .next()
                .text()
                .trim();
    ...
    $(".form-check-input").click(function () {
        ...
        if ($(this).is(":checked")) {
            ...
            $("#longrow").append(
                ' <div class="d-flex flex-row filteredlabels" id="ns' +
                    topId +
                    '"><div class="d-flex flex-column col-9"><div class="text1">' +
                    text +
                    '</div><div class=text2>Lorem</div> </div><div style="border-left: solid 0.5px #c9c9c9;"><a style="cursor: pointer;" id="ns' +
                    topId +
                    '"  onclick="myFunction(\'' +
                    "ns" +
                    topId +
                    '\')"><img style="" src="./assets/closeitem.svg" alt=""></a> </div></div>'
            );
    ...
    $(".typeBrand").keyup(function () {
        var typeBrandText = document.getElementsByClassName("typeBrand")[0]
            .value;
